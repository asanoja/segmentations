...
public class Vips {
	...
	long endTime = 0;
        ...
        public static int publicpDOC = 11;
	...
	private void getDomTree(InputStream urlStream)
	{
		//DOMSource parser = new DOMSource(urlStream);
            ...
            try {
                docSource = new DefaultDocumentSource(_url);
	...
	private void performSegmentation()
	{
		...
		{
                        System.out.println("JVIPS: Iteration "+iterationNumber);
		...
		try
		{
			...
			if (_outputToFolder)
			{
				...
				else
				{
                    ...
                    System.out.println("jVIPS: segmenting");
			performSegmentation();
