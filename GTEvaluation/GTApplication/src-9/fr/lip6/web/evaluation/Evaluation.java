...
public class Evaluation {
    ...
    public void measure(double ti) {
        for (Edge e : bcg.getEdges()) {
            ...
            if (ni.getBlock().getParent().getAlgo()=="GT") {
                gtnode = ni;
            } else {
                gtnode = nj;
            }
    ...
    public void save(int tt,double tr,double ti) {
        try {
            ...
            String sql = ("insert into metrics(page_id,cc,co,cu,cm,cf,cq,icc,ico,icu,icm,icf,icq,tt,tr,ti,gtb,ptb,segmentation1_id,segmentation2_id) values ('"+g.getPage_id()+"','"+getCc()+"','"+getCo()+"','"+getCu()+"','"+getCm()+"','"+getCf()+"','"+getCq()+"','"+getICc()+"','"+getICo()+"','"+getICu()+"','"+getICm()+"','"+getICf()+"','"+getICq()+"','"+tt+"','"+tr+"','"+ti+"','"+g.getBlocks().size()+"','"+p.getBlocks().size()+"','"+g.getId()+"','"+p.getId()+"');");
