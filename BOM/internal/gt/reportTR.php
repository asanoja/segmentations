			...
			<?php 
				...
				$trmax= 1;
					for ($tr=0;$tr<=$trmax;$tr+=0.1) {
						...
						if ($variable!="cf") {
							$sql_r="select 'GT',avg(metrics.gtb) from metrics where tr='".$tr."' ".$cq." group by tr;\n";
						} else {
							$sql_r="select 'GT',avg(metrics.stb) from metrics where tr='".$tr."' ".$cq." group by tr;\n";
						}
						...
						$sql_r="select algo2,avg(metrics.`".$variable."`) from metrics where algo2='BOM' and browser2='chrome' and tr='".$tr."' ".$cq." group by tr;";
						$detail = mysql_query($sql_r,$link); 
						if ($r = mysql_fetch_array($detail)) {
						...
						$sql_r="select algo2,avg(metrics.`".$variable."`) from metrics where algo2='JVIPS' and browser2='cssbox' and tr='".$tr."' ".$cq." group by tr;";
						$detail = mysql_query($sql_r,$link); 
						if ($r = mysql_fetch_array($detail)) {
						...
						$sql_r="select algo2,avg(metrics.`".$variable."`) from metrics where algo2='BF' and browser2='chrome' and tr='".$tr."' ".$cq." group by tr;";
						$detail = mysql_query($sql_r,$link); 
						if ($r = mysql_fetch_array($detail)) {
						...
						$sql_r="select algo2,avg(metrics.`".$variable."`) from metrics where algo2='VIPS' and browser2='iexplorer' and tr='".$tr."' ".$cq." group by tr;";
						$detail = mysql_query($sql_r,$link); 
						if ($r = mysql_fetch_array($detail)) {
...
<form action="reportTR.php" method="get">
