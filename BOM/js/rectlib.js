function rectObj() {
	...
	this.rectInit = function() {
		...
		this.data.style.overflow = "none";
	}
	this.setContent = function(cont) {
		this.data.innerHTML = "<span style='color:black;z-index:100000;font-size:10px'>"+cont+"</span>";
	}
	...
	this.scale = function(nw,nh,bw,bh) {
		var x = nw*this.getRect().left / bw;
		var y = nh*this.getRect().top / bh;
		var w = nw*this.getRect().width / bw;
		var h = nh*this.getRect().height / bh;
